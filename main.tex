...
\end{theorem}
The proof is straightforward: send $\Run(\cube n)$ to topes, and observe that the 
composition operator agrees with the projection. This is machine-checked in \cite{Cubical}.
